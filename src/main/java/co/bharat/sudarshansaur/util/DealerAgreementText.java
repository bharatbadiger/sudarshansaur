...
public class DealerAgreementText {
    ...
    public static String para6() {
        ...
        para.append("\nClean Development Mechanism: The Company intends to participate in the Clean Development Mechanism (CDM) and the Dealer undertakes that he will take responsibility to collect the Customer Authorization Forms (CAF) as and when required by the Company and also assist the Company in fulfilling the requirements under the CDM. The Dealer also undertakes not to parallel to participate in the CDM with any other party(s) and/or assign the Carbon Credits to any other entity, without the written permission and approval of the Company. The Dealer also acknowledges that all \tCarbon Credits accrued due to the activities of the Dealer shall remain in favor of the Company.\n\n");
